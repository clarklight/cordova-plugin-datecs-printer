...
public class Printer {
    ...
    public void printTextnew(String s) throws IOException {
        if(s == null) {
            throw new NullPointerException("The s is null");
        } else {
            synchronized(this) {
                this.printTextnew(s.getBytes());
            }
        }
    }

    public void printTextnew(String s, String encoding) throws IOException {
        if(s == null) {
            throw new NullPointerException("The s is null");
        } else {
            synchronized(this) {
                this.printTextnew(s.getBytes(encoding));
            }
        }
    }
    ...
    public void printTaggedText(String s, String encoding) throws IOException {
      ...
      private void printTaggedTextnew(byte[] b) throws IOException {
        boolean LEN = true;
        boolean ELE = true;
        boolean END = true;
        boolean DET = true;
        ...
        if(b == null) {
            ...
            synchronized(this) {
                byte[] var33 = new byte[var32];
                System.arraycopy(tbuf, 0, var33, 0, var33.length);
                this.printTextnew(var33);
            }
        }
    }

    public void printTaggedTextnew(String s) throws IOException {
        if(s == null) {
            throw new NullPointerException("The s is null");
        } else {
            this.printTaggedTextnew(s.getBytes());
        }
    }

    public void printTaggedTextnew(String s, String encoding) throws IOException {
        if(s == null) {
            throw new NullPointerException("The s is null");
        } else {
